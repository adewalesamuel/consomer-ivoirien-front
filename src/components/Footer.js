                    ...
                    <div className="row">
                        <div className="col-lg-4 col-md-4 col-sm-9">
                            <section className="footer-item">
                                <a href="home-04.html" className="logo footer-logo"><img src="/assets2/images/organic-4.png" alt="biolife logo" width="135" height="36" /></a>
                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-6 col-sm-6 col-xs-12">
                            <div className="payment-methods">
                                <ul>
                                    <li><a href="#" className="payment-link"><img src="/assets2/images/card1.jpg" width="51" height="36" alt="" /></a></li>
                                    <li><a href="#" className="payment-link"><img src="/assets2/images/card2.jpg" width="51" height="36" alt="" /></a></li>
                                    <li><a href="#" className="payment-link"><img src="/assets2/images/card3.jpg" width="51" height="36" alt="" /></a></li>
                                    <li><a href="#" className="payment-link"><img src="/assets2/images/card4.jpg" width="51" height="36" alt="" /></a></li>
                                    <li><a href="#" className="payment-link"><img src="/assets2/images/card5.jpg" width="51" height="36" alt="" /></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
